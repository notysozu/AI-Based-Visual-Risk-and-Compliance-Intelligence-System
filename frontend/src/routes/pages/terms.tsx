...
export const Route = createFileRoute("/pages/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Visual Risk AI (VRCI)" },
      {
        name: "description",
        content: "Review the terms, simulation modeling guidelines, and disclaimer policies for using AI-Based Visual Risk and Compliance Intelligence System (Visual Risk AI (VRCI)).",
      },
    ],
  }),
  component: TermsPage,
        ...
        <div className="space-y-8">
          ...
          <div className="antigravity-glass p-8 rounded-3xl border border-border/80 shadow-[var(--clay-shadow)]">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              By accessing or creating an account on AI-Based Visual Risk and Compliance Intelligence System (Visual Risk AI (VRCI)), you acknowledge and agree to be bound by these Terms of Service. If you disagree with any portion of these terms, please discontinue using the service.
            </p>
          </div>
          ...
          <div className="antigravity-glass p-8 rounded-3xl border border-amber-500/30 bg-amber-500/5 shadow-[var(--clay-shadow)]">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              AI-Based Visual Risk and Compliance Intelligence System (Visual Risk AI (VRCI)) provides probabilistic algorithmic risk modeling, 500-iteration Monte Carlo projections, focus momentum metrics, and syllabus scheduling for educational, self-reflection, and personal planning purposes only:
            </p>
          ...
          <div className="antigravity-glass p-8 rounded-3xl border border-border/80 shadow-[var(--clay-shadow)]">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              All proprietary algorithms, simulation engine code, user interfaces, branding, and visual designs remain the intellectual property of AI-Based Visual Risk and Compliance Intelligence System (Visual Risk AI (VRCI)) and its maintainers. You retain full ownership of all custom data and parameters you input.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 pb-12 border-b border-border/40">
            ...
            <div className="col-span-2 space-y-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-foreground text-sm tracking-tight">Visual Risk AI (VRCI)</span>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-[11px] text-muted-foreground text-center sm:text-left">
              © {new Date().getFullYear()} AI-Based Visual Risk & Compliance Intelligence System (Visual Risk AI (VRCI)). All rights reserved.
            </div>
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visual Risk AI GitHub"
