...
import { useTwin, type Profile, type UserRole, ROLE_CONFIGS, DEFAULT_PROFILE, money } from "@/lib/twin-store";
import { toast } from "sonner";

export const Route = createFileRoute("/setup")({
  head: () => ({
    meta: [
      { title: "Set up your intelligence — Digital Twin AI" },
      { name: "description", content: "Answer a few questions so your twin can model your life." },
      { property: "og:title", content: "Set up your intelligence — Digital Twin AI" },
      {
